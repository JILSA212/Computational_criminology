...
function setUpClickListener(map) {
  ...
  map.addEventListener('tap', function (evt) {
    ...
    locations.push({lat: coord.lat, lng: coord.lng});
    //console.log(locations);
    localStorage.setItem("sgp_locs", JSON.stringify(locations));
    var storedNames = JSON.parse(localStorage.getItem("sgp_locs"));
...
var platform = new H.service.Platform({
  apikey: 't55Lr-H5K_sXa9HRf7DWS39Ihik5DBeaKM0hRMaY8uY'
});
